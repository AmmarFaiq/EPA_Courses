...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    dike_lev2 = {'DikeIncrease': [0, 10]}     # dm
...
#    EWS_lev2 = {'EWS_DaysToThreat': [0,3]}  # days
    ...
    for dike in function.dikelist:
        ...
        for uncert_name in cat_uncert_loc.keys():
         ...
         # Change range of the specific levers
        if ((dike == 'A.1') | (dike == 'A.3')) :

            for lev_name in dike_lev.keys():
                name = "{}_{}".format(dike, lev_name)
                levers.append(IntegerParameter(name, dike_lev2[lev_name][0],
                                               dike_lev2[lev_name][1]))
        else :
